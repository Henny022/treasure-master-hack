...
tm_64_16_test::tm_64_16_test()
{
    ...
    generate_alg2_values_64_16(alg2_values, rng_table);

    alg5_values = new uint64_t[0x10000];
    generate_alg5_values_64_16(alg5_values, rng_table);
...
void tm_64_16_test::process_test_case(uint8_t *test_case, uint16_t *rng_seed,
                                      int algorithm)
{
    ...
    {
        alg1((uint64_t *)working_code, (uint64_t *)regular_rng_values,
             *rng_seed);
        *rng_seed = rng_seed_forward_128[*rng_seed];
    }
    else if (algorithm == 2)
    ...
    {
        alg1((uint64_t *)working_code, (uint64_t *)alg4_values, *rng_seed);
        *rng_seed = rng_seed_forward_128[*rng_seed];
    }
    else if (algorithm == 5)
    {
...
void tm_64_16_test::run_iterations(uint8_t *test_case, uint16_t *rng_seed,
