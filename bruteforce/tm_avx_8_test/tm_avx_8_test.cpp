...
tm_avx_8_test::tm_avx_8_test()
{
    ...
    generate_alg2_values_256_8(alg2_values, rng_table);

    alg5_values = (uint8_t *)aligned_malloc(0x10000 * 32, 32);
    generate_alg5_values_256_8(alg5_values, rng_table);
...
void tm_avx_8_test::process_test_case(uint8_t *test_case, uint16_t *rng_seed,
                                      int algorithm)
{
...
void tm_avx_8_test::run_iterations(uint8_t *test_case, uint16_t *rng_seed,
