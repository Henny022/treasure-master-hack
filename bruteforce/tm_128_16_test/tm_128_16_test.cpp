...
tm_128_16_test::tm_128_16_test()
{
    ...
    generate_alg2_values_128_16(alg2_values, rng_table);

    alg5_values = (uint8_t *)aligned_malloc(0x10000 * 16, 32);
    generate_alg5_values_128_16(alg5_values, rng_table);
...
void tm_128_16_test::process_test_case(uint8_t *test_case, uint16_t *rng_seed,
                                       int algorithm)
{
...
void tm_128_16_test::run_iterations(uint8_t *test_case, uint16_t *rng_seed,
